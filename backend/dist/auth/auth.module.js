...
exports.AuthModule = AuthModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [
            ...
            oauth_enabled_guard_1.GoogleOAuthEnabledGuard,
            oauth_enabled_guard_1.FacebookOAuthEnabledGuard,
            dev_only_guard_1.DevOnlyGuard,
            ...(googleEnabled ? [google_strategy_1.GoogleStrategy] : []),
            ...(facebookEnabled ? [facebook_strategy_1.FacebookStrategy] : []),
        ],
